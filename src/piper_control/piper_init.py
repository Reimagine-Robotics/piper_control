"""Module for enabling, disabling, and resetting the arm and gripper."""
...
def disable_gripper(
    piper: pi.PiperInterface, *, timeout_seconds: float = 10.0
) -> None:
  """
...
def reset_gripper(
  ...
  # Try the direct quick way first.
  enable_gripper(piper, timeout_seconds=timeout_seconds)
  if piper.is_gripper_enabled():
    return

  timeout_trigger = _create_timeout(timeout_seconds, "reset_gripper")
  while True:
